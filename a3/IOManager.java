...
public class IOManager {
	...
	private final int[][] failMatrix = new int[][] {{0, 1, 2}, {1, 0, 1}, {2, 1, 0}};
     ...
     * 
     **********************************************/
    public int[] getEdgeWeightSection() throws Exception {
    ...
    public int[] getDemandSection() throws Exception {
    ...
    public int getAntCapacity() throws Exception {
        int ant = 0;
